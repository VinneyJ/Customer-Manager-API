"""
Django settings for customer_manager_api project.
...
ROOT_URLCONF = "customer_manager_api.urls"
...
WSGI_APPLICATION = "customer_manager_api.wsgi.application"
...
REST_AUTH = {
    "USE_JWT": True,
    "JWT_AUTH_COOKIE": "manager-access-token",
    "JWT_AUTH_REFRESH_COOKIE": "managers-refresh-token",
